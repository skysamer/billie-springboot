...
### 5.4. 지속적이고 실시간으로 도메인의 대여 상태를 업데이트 해야하는 문제
...
### 6.4. 실시간 알림 전송 및 알림 데이터 저장 로직을 이벤트 리스너로 제어
...
### 6.6. url의 간소화 및 각 api를 restful 하도록 설계(신규기능 건)
